 ...
 */
public class ComunicBTs extends AsyncTask<Void, byte[], Integer> {
...
//	}
	 ...
	 */
	public ComunicBTs(BluetoothDevice btDev, Context ui) {
		estado = NULL;
		tcon = CLIENT;
		context = ui;
		mDevice = btDev;
	 ...
	 * @param ui the UI Context
	 */
	public ComunicBTs(BluetoothAdapter btAdap, Context ui) {
		estado = NULL;
		tcon = SERVER;
		context = ui;
		BTAdapter = btAdap;
